#!/usr/bin/env python3
"""
Generate Karis Properties PDF with proper repeating headers/footers using Chrome's template system
"""
...
def create_pdf_with_chrome_headers():
    """Create PDF with Chrome's built-in header/footer templates"""
    ...
    # Main PDF HTML - simplified without fixed headers
...
""" + content_html + """
    ...
    # Chrome header template (appears on pages 2+)
    header_template = """
    <div style="width: 100%; padding: 0 0.5in; margin-top: 0.3in; display: flex; justify-content: space-between; align-items: center; border-bottom: 1.5pt solid #e8f1f8; padding-bottom: 10px; font-size: 9.5pt; color: #4a5f7a; font-family: -apple-system, sans-serif;">
        <div style="display: flex; align-items: center; gap: 8px; font-weight: 600;">
            <img src="https://bogen.ai/images/eb-logo.png" style="height: 24px;">
            <span>Karis Properties USA</span>
        </div>
        <div style="color: #6b7d94; font-weight: 500;">Website Development Proposal</div>
    </div>
    """

    # Chrome footer template (appears on pages 2+)
    footer_template = """
    <div style="width: 100%; padding: 0 0.5in; margin-bottom: 0.3in; display: flex; justify-content: space-between; align-items: center; border-top: 1.5pt solid #e8f1f8; padding-top: 10px; font-size: 8.5pt; color: #8899aa; font-family: -apple-system, sans-serif;">
        <div style="display: flex; align-items: center;">
            <img src="https://bogen.ai/images/eb-logo.png" style="height: 22px;">
        </div>
        <div style="font-weight: 600;">Page <span class="pageNumber"></span></div>
    </div>
    """
    ...
    try:
        ...
        # Use Chrome's display-header-footer option
        cmd = [
            chrome_path,
            '--headless=new',
            '--disable-gpu',
        ...
        print(f"✓ Generating PDF with Chrome headers/footers...")
...
if __name__ == "__main__":
    create_pdf_with_chrome_headers()
